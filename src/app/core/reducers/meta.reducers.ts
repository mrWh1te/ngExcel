...
import { actionStatesLoggerMetaReducer } from './action-states-logger.meta-reducer'
...
export const metaReducersFactory = (storageService: LocalStorageService): MetaReducer<RootState>[] => 
  [actionStatesLoggerMetaReducer, syncStateWithLocalStorageMetaReducer(['spreadsheet'], storageService)]